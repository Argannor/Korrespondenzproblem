...
\frame{
	...
	\begin{itemize}
		...
		\item $G$ ist dann mehrdeutig, wenn $G_x$ und $G_y$ mindestens ein gemeinsames Wort erzeugen. Dann hat das PKP $x_{i_k}...x_{i_1}a{i_1}...a{i_k} = y_{i_k}...y_{i_1}a{i_1}...a{i_k}$ mindestens eine Lösung mit der Indexfolge $I = {i_1, i_2, ... i_k}$.
...
\frame{
	...
	Dkf Sprachen sind unter Komplementbildung abgeschlossen.
	...
	\end{tabbing}
		Mit dem Übergang zur Komplementgrammatik $G_2 \mapsto G'_2$ (dkf) und
		
		dem Übergang zur Vereinigungsgrammatik $G_1, G'_2 \mapsto G_3$ (kf).
	\end{block}
...
\frame{
	...
	\begin{itemize}
		...
		\item Funke, Danile: Präsentation zur Reduzierbarkeit. DHBW Karlsruhe 2009.
	\end{itemize}
}
